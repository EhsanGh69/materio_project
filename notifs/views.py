...
from utils.tools import get_comment_answers, users_filter
...
@login_required
@permission_required('notifs.view_ticket', raise_exception=True)
...
@login_required
@permission_required(['notifs.view_ticket', 'notifs.change_ticket'], raise_exception=True)
...
@login_required
@permission_required('notifs.delete_ticket')
...
def all_notifs(request: HttpRequest):
    if request.user.is_superuser or request.user.has_perms(['notifs.view_notification']):
...
@login_required
@permission_required('notifs.add_notification', raise_exception=True)
...
@login_required
@permission_required('notifs.delete_notification')
